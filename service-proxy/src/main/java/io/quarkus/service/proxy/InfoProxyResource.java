...
@Path("/info")
public class InfoProxyResource {

    private Logger log = Logger.getLogger(InfoProxyResource.class);
    private static final String PATH = "/q/info";
    ...
    public Response proxy(String namespace, String name) {
        ...
        log.info("Proxying info endpint: http://" + name + "." + namespace + PATH);
        return client
